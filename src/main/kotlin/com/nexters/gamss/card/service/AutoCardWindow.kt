...
class AutoCardWindow(
    ...
    companion object {
         ...
         * 만들어져 리마인더를 받지 못하는 방이 길게 생기지 않을 만큼이다.
         *
         * 리마인더 시각은 이 값과 [DAY_BOUNDARY_HOUR] 에서 나온다. 리마인더의 cron
         * ([com.nexters.gamss.notification.service.UnfinishedConversationReminder])이 여기서 값을
         * 받아 가므로, 경계를 옮길 때 고칠 곳은 이 companion 뿐이다.
         */
