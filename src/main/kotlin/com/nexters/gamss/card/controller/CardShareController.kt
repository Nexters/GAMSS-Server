    ...
    @Operation(
        ...
        description =
            "공유 링크(`gamss.kr/c/{shareToken}`)를 연 사람에게 보여줄 카드입니다. " +
                ...
                "**앱도 이 API 를 씁니다.** 링크를 누른 사람에게 앱이 있으면 OS 가 앱으로 넘기는데, " +
                "그때 앱은 경로에서 토큰을 떼어 여기로 물어보고 공유된 카드 화면을 띄웁니다. " +
                "앱이 없으면 같은 주소가 웹 페이지로 열리고 그 페이지가 같은 응답을 그립니다.\n\n" +
                "로그인 상태로 불러도 됩니다 — 응답은 같습니다.\n\n" +
