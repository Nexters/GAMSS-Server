...
/**
 * 대화방을 저장하기 직전에 제목의 검색용 블라인드 인덱스를 채운다.
 *
 ...
 * [com.nexters.gamss.conversation.repository.ConversationRepository] 의 벌크 쿼리는 상태·시각 컬럼만 건드린다 — 새로 추가할 때 확인할 것.
 */
@Component
class ConversationSearchIndexListener(
    ...
    fun fillSearchIndex(conversation: Conversation) {
        conversation.applySearchIndex(indexer)
    }
}
