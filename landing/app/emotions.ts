...
export type Emotion = {
  ...
  color: string;
  /**
   * 카드 미리보기에 넣을 대화 요약 예시.
   *
   * **줄바꿈을 직접 넣는다.** 카드가 좁아 자동 줄바꿈에 맡기면 마지막 줄에 어절 하나만
   * 떨어져 보기 나쁘다. `\n` 기준으로 끊고 **2줄을 넘기지 않는다** — 넘치면 카드 높이가 서로 어긋난다.
   */
  summary: string;
...
export const NOTES = [
  ...
  { text: "나 사실\n안 괜찮아", color: "#376ce8", tape: "rgba(55, 108, 232, 0.25)" },
];
